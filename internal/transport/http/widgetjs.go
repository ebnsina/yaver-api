...
const widgetJS = `(function () {
  ...
  var css =
    ...
    '.launcher{position:fixed;bottom:20px;right:20px;width:56px;height:56px;border-radius:9999px;background:#111827;color:#fff;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 6px 20px rgba(0,0,0,.18);z-index:2147483000}' +
    ...
    '.hd .av{width:30px;height:30px;border-radius:8px;background:#111827;color:#fff;font-weight:700;font-size:13px;display:flex;align-items:center;justify-content:center}' +
    ...
    '.u{align-self:flex-end;background:#111827;color:#fff;border-bottom-right-radius:5px}' +
    ...
    '.cp button{width:38px;height:38px;border:none;border-radius:10px;background:#111827;color:#fff;cursor:pointer;display:flex;align-items:center;justify-content:center}' +
